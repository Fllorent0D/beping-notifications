...
export class DivisionsService {
    ...
    public findAllDivisions(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: 'no' | 'yes' | 'short', ): Observable<any> {
        ...
        return this.httpClient.get<Array<DivisionEntry>>(`${this.basePath}/v1/divisions`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findDivisionById(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: 'no' | 'yes' | 'short', ): Observable<AxiosResponse<DivisionEntry>>;
    public findDivisionById(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: 'no' | 'yes' | 'short', ): Observable<any> {

        if (divisionId === null || divisionId === undefined) {
            throw new Error('Required parameter divisionId was null or undefined when calling findDivisionById.');
        }
        ...
        return this.httpClient.get<DivisionEntry>(`${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findDivisionMatches(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, weekName?: number, yearDateFrom?: string, yearDateTo?: string, withDetails?: boolean, ): Observable<AxiosResponse<Array<TeamMatchesEntry>>>;
    public findDivisionMatches(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, weekName?: number, yearDateFrom?: string, yearDateTo?: string, withDetails?: boolean, ): Observable<any> {

        if (divisionId === null || divisionId === undefined) {
            throw new Error('Required parameter divisionId was null or undefined when calling findDivisionMatches.');
        }
        ...
        return this.httpClient.get<Array<TeamMatchesEntry>>(`${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/matches`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findDivisionMembers(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, season?: number, ): Observable<AxiosResponse<Array<MemberResults>>>;
    public findDivisionMembers(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, season?: number, ): Observable<any> {

        if (divisionId === null || divisionId === undefined) {
            throw new Error('Required parameter divisionId was null or undefined when calling findDivisionMembers.');
        }
        ...
        return this.httpClient.get<Array<MemberResults>>(`${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/members/ranking`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findDivisionRanking(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, weekName?: number, rankingSystem?: number, ): Observable<AxiosResponse<Array<RankingEntry>>>;
    public findDivisionRanking(divisionId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, weekName?: number, rankingSystem?: number, ): Observable<any> {

        if (divisionId === null || divisionId === undefined) {
            throw new Error('Required parameter divisionId was null or undefined when calling findDivisionRanking.');
        }
        ...
        return this.httpClient.get<Array<RankingEntry>>(`${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/ranking`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
