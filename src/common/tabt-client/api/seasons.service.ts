...
export class SeasonsService {
    ...
    public findAllSeason(): Observable<any> {
        ...
        return this.httpClient.get<Array<SeasonEntry>>(`${this.basePath}/v1/seasons`,
            {
    ...
    public findCurrentSeason(): Observable<any> {
        ...
        return this.httpClient.get<SeasonEntry>(`${this.basePath}/v1/seasons/current`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
            }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findSeasonById(seasonId: number, ): Observable<AxiosResponse<SeasonEntry>>;
    public findSeasonById(seasonId: number, ): Observable<any> {

        if (seasonId === null || seasonId === undefined) {
            throw new Error('Required parameter seasonId was null or undefined when calling findSeasonById.');
        }
        ...
        return this.httpClient.get<SeasonEntry>(`${this.basePath}/v1/seasons/${encodeURIComponent(String(seasonId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
            }
