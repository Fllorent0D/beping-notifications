...
export class InternalIdentifiersService {
     ...
     */
    public getInternalIds(clubUniqueIndex: string, database: string, playerUniqueIndex: number, ): Observable<AxiosResponse<InternalIdentifiersDTO>>;
    public getInternalIds(clubUniqueIndex: string, database: string, playerUniqueIndex: number, ): Observable<any> {

        if (clubUniqueIndex === null || clubUniqueIndex === undefined) {
            throw new Error('Required parameter clubUniqueIndex was null or undefined when calling getInternalIds.');
        }

        if (database === null || database === undefined) {
            throw new Error('Required parameter database was null or undefined when calling getInternalIds.');
        }

        if (playerUniqueIndex === null || playerUniqueIndex === undefined) {
            throw new Error('Required parameter playerUniqueIndex was null or undefined when calling getInternalIds.');
        }

        let queryParameters = {};
        if (clubUniqueIndex !== undefined && clubUniqueIndex !== null) {
            queryParameters['clubUniqueIndex'] = <any>clubUniqueIndex;
        }
        if (database !== undefined && database !== null) {
            queryParameters['database'] = <any>database;
        }
        if (playerUniqueIndex !== undefined && playerUniqueIndex !== null) {
            queryParameters['playerUniqueIndex'] = <any>playerUniqueIndex;
        }
        ...
        return this.httpClient.get<InternalIdentifiersDTO>(`${this.basePath}/v1/internal-identifiers`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getRegisterLink(clubUniqueIndex: string, database: string, playerUniqueIndex: number, ): Observable<AxiosResponse<RedirectLinkDTO>>;
    public getRegisterLink(clubUniqueIndex: string, database: string, playerUniqueIndex: number, ): Observable<any> {

        if (clubUniqueIndex === null || clubUniqueIndex === undefined) {
            throw new Error('Required parameter clubUniqueIndex was null or undefined when calling getRegisterLink.');
        }

        if (database === null || database === undefined) {
            throw new Error('Required parameter database was null or undefined when calling getRegisterLink.');
        }

        if (playerUniqueIndex === null || playerUniqueIndex === undefined) {
            throw new Error('Required parameter playerUniqueIndex was null or undefined when calling getRegisterLink.');
        }
        ...
        return this.httpClient.get<RedirectLinkDTO>(`${this.basePath}/v1/internal-identifiers/link`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
