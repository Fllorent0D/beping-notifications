...
export class Head2HeadService {
	...
	public findHead2HeadMatches(playerUniqueIndex: number,
		opponentUniqueIndex: number,): Observable<any> {
		...
		return this.httpClient.get<any>(`${this.basePath}/v1/head2head/${encodeURIComponent(String(playerUniqueIndex),)}/${encodeURIComponent(String(opponentUniqueIndex))}`,
			{
