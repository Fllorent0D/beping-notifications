...
export class Head2HeadService {
     ...
     */
    public findHead2HeadMatches(playerUniqueIndex: number, opponentUniqueIndex: number, ): Observable<AxiosResponse<Head2HeadData>>;
    public findHead2HeadMatches(playerUniqueIndex: number, opponentUniqueIndex: number, ): Observable<any> {

        if (playerUniqueIndex === null || playerUniqueIndex === undefined) {
            throw new Error('Required parameter playerUniqueIndex was null or undefined when calling findHead2HeadMatches.');
        }

        if (opponentUniqueIndex === null || opponentUniqueIndex === undefined) {
            throw new Error('Required parameter opponentUniqueIndex was null or undefined when calling findHead2HeadMatches.');
        }
        ...
        return this.httpClient.get<Head2HeadData>(`${this.basePath}/v1/head2head/${encodeURIComponent(String(playerUniqueIndex))}/${encodeURIComponent(String(opponentUniqueIndex))}`,
            {
