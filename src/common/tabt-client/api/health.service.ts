...
export class HealthService {
     ...
     */
    public checkHealth(): Observable<AxiosResponse<InlineResponse200>>;
    public checkHealth(): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse200>(`${this.basePath}/v1/health`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public context(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<AxiosResponse<any>>;
    public context(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testRequest(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<AxiosResponse<TestOutput>>;
    public testRequest(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<any> {
        ...
        return this.httpClient.get<TestOutput>(`${this.basePath}/v1/health/test`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
            }
