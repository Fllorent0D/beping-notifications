...
export class MatchesService {
     ...
     */
    public findAllMatchSystems(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<AxiosResponse<Array<MatchSystemEntry>>>;
    public findAllMatchSystems(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<any> {
        ...
        return this.httpClient.get<Array<MatchSystemEntry>>(`${this.basePath}/v1/matches/systems`,
            {
    ...
    public findAllMatches(xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, divisionId?: number, club?: string, team?: string, divisionCategory?: 'MEN' | 'WOMEN' | 'VETERANS' | 'VETERANS_WOMEN' | 'YOUTH', weekName?: number, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: string, yearDateFrom?: string, yearDateTo?: string, withDetails?: boolean, matchId?: string, matchUniqueId?: string, ): Observable<any> {
        ...
        return this.httpClient.get<Array<TeamMatchesEntry>>(`${this.basePath}/v1/matches`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findMatchById(matchUniqueId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, divisionId?: number, club?: string, team?: string, divisionCategory?: 'MEN' | 'WOMEN' | 'VETERANS' | 'VETERANS_WOMEN' | 'YOUTH', weekName?: number, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: string, yearDateFrom?: string, yearDateTo?: string, withDetails?: boolean, matchId?: string, ): Observable<AxiosResponse<TeamMatchesEntry>>;
    public findMatchById(matchUniqueId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, divisionId?: number, club?: string, team?: string, divisionCategory?: 'MEN' | 'WOMEN' | 'VETERANS' | 'VETERANS_WOMEN' | 'YOUTH', weekName?: number, level?: 'NATIONAL' | 'HAINAUT' | 'VLAAMS_BRABANT_BR' | 'SUPER_DIVISION' | 'OOST_VLANDEREN' | 'ANTWERP' | 'WEST_VLAANDEREN' | 'LIMBURG' | 'BRUSSELS_BRABANT_WALLON' | 'NAMUR' | 'LIEGE' | 'LUXEMBOURG' | 'REGION_VTTL' | 'IWB', showDivisionName?: string, yearDateFrom?: string, yearDateTo?: string, withDetails?: boolean, matchId?: string, ): Observable<any> {

        if (matchUniqueId === null || matchUniqueId === undefined) {
            throw new Error('Required parameter matchUniqueId was null or undefined when calling findMatchById.');
        }
        ...
        return this.httpClient.get<TeamMatchesEntry>(`${this.basePath}/v1/matches/${encodeURIComponent(String(matchUniqueId))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findMatchSystemById(matchSystemId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<AxiosResponse<MatchSystemEntry>>;
    public findMatchSystemById(matchSystemId: number, xTabtAccount?: string, xTabtPassword?: string, xTabtOnBehalfOf?: string, xTabtDatabase?: 'aftt' | 'vttl', xTabtSeason?: string, ): Observable<any> {

        if (matchSystemId === null || matchSystemId === undefined) {
            throw new Error('Required parameter matchSystemId was null or undefined when calling findMatchSystemById.');
        }
        ...
        return this.httpClient.get<MatchSystemEntry>(`${this.basePath}/v1/matches/systems/${encodeURIComponent(String(matchSystemId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
            }
