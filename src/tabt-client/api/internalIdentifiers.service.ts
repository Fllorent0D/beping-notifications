...
export class InternalIdentifiersService {
  ...
  public getInternalIds(
    ...
    if (database === null || database === undefined) {
      throw new Error(
        'Required parameter database was null or undefined when calling getInternalIds.',
      );
    }
  ...
  public getRegisterLink(
    ...
    if (database === null || database === undefined) {
      throw new Error(
        'Required parameter database was null or undefined when calling getRegisterLink.',
      );
    }
