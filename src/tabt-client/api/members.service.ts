...
export class MembersService {
  ...
  public findMemberEloHistory(
    ...
    if (uniqueIndex === null || uniqueIndex === undefined) {
      throw new Error(
        'Required parameter uniqueIndex was null or undefined when calling findMemberEloHistory.',
      );
    }
    ...
    // to determine the Content-Type header
    const consumes: string[] = [];
    return this.httpClient.get<Array<WeeklyELO>>(
      `${this.basePath}/v1/members/${encodeURIComponent(
        String(uniqueIndex),
      )}/elo`,
      {
        params: queryParameters,
